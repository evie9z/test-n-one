# -*- coding: utf-8 -*-
"""train_and_predict_v1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dgTUQEOqulO_qp_58X3wbLDZbV84oO8b
"""
        ...
        with tf.Session() as sess2:
            ...
            while (True):
                ...
                if (np.argmax(predictions2) != marker):
                    ...
                    if (prev_preds.count(np.argmax(predictions2)) > 4):  # CHANGE NUMBER FOR MORE OR LESS FLEXIBILITY
